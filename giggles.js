...
//缓存离线超时时间
const MAX_ACCESS_CACHE_TIME = 60 * 60 * 24 * 6
...
const cacheList = {
    ...
    resources: {
        url: /(^(https:\/\/(www\.chuckle\.top|chuckle\.top|blog\.chuckle\.top))).*\.(css|html|webp|png|jpg|gif|ico|js|woff2|woff|ttf|json|svg)$/g,
        time: 60 * 60 * 24 * 2,
        clean: true
    }
    /* stand: {
